...
function getAllSubscriptions() {
    ...
    $.get("api/getAllSubscriptions", {}, function (data) {
        ...
        if (is_not_activated) {
            ...
            Увага! Ваш аккаунт не активовано! На реальному проекті це б означало, що ви б не могли користуватись функціями сайту (або навіть авторизуватись).<br><br>
...
function updateOLXPrices(){
    // NOTE: Цієї функції не має бути, але треба ж дати змогу перевіряючим тестове через фронт примусово пройтись по всім оголошенням
